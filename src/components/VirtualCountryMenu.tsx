...
const IconButtonDialCodeStyled = styled('div')(({ theme }) => ({
  fontSize: '1rem',
  lineHeight: '1rem',
  paddingLeft: 8,
  paddingTop: 2,
...
const VirtualCountryMenu = ({ FlagComponent, selectedCountry, countries, localization, onCountrySelected }) => {
      ...
      renderInput={(params) => (
        ...
        >
          <IconButtonStyled onClick={() => setOpen(!open)}>
            ...
            <IconButtonDialCodeStyled>+{selectedCountry.dialCode}</IconButtonDialCodeStyled>
            <Caret />
          </IconButtonStyled>
      ...
      renderOption={(props, country) => {
        ...
        return (
          ...
          >
            ...
            <span>
              {(localization && localization[country.name]) || country.name} +{country.dialCode}
            </span>
          </Stack>
        )
      }}
      getOptionLabel={(country) => (localization && localization[country.name]) || country.name}
    />
  )
}
